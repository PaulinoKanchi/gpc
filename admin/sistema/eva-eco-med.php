...
<body class="h-100">
            ...
            <div class="col-lg-9 col-md-12">
              ...
              <div class="card card-small mb-3">
                <div class="card-body">
                  ...
                  <form class="add-new-post" method="post" action="guardado-eco-med.php?id=<?php echo $id; ?>">
                    <?php
              ...
              --><br> DESCRIPCION: <textarea id="descripcion" name="descripcion" maxlength="100" aria-invalid="false" style="padding:12px;background-color:#dddddd;margin: 0px 15.6597px 0px 0px; width: 670px; height: 128px;" type="text" readonly> <?php echo $descripcion ?></textarea>
                  ...
                  <BR> Descuento:<input id="descuento" size=50 class="mi-selector form-control-lg mb-3" style="padding:12px;background-color:#dddddd;margin-left:10px;margin-right:0px" name="descuento" readonly required>
  ...
  <script type="text/javascript">
    ...
    function mostrar1(num) {
      ...
      if ((dic1 == 0)
        /*||(dic2==0)||(dic3==0)||(dic4==0)||(dic5==0)||(dic6==0)||(dic7==0)||(dic8==0)||(dic9==0)
          ||(dic10==0)||(dic11==0)||(dic12==0)||(dic13==0)||(dic14==0)*/
      ) {
        document.getElementById('dictamen').value = "No Cumple";
      } else if ((dic1 == 3)
        /*&&(dic2==3)&&(dic3==3)&&(dic4==3)&&(dic5==3)&&(dic6==3)&&(dic7==3)&&(dic8==3)&&(dic9==3)
