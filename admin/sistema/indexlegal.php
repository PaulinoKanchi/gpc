...
<!--desde aqui comienza catalogos-->
              <li class="nav-item">
               ...
               <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                  <!--   <a class="dropdown-item" id="nav-eva-tec-med">
                      <i class="material-icons">description</i>Nva. Evaluación Tecnica </a>
                  
                      <a class="dropdown-item" id="nav-eva-eco-med">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                  <!--  <a class="dropdown-item" id="nav-eva-tec-mat">
                    <i class="material-icons">description</i>Nva. Evaluación Tecnica Material</a>

                    <a class="dropdown-item" id="nav-eva-eco-mat">
                    <i class="material-icons">description</i>Nva. Evaluación Económica Material</a>-->

                    <a class="dropdown-item" href="eva-leg-mat-ch.php?username=<?php echo $usertra;?>&tipo=<?php echo $tipoo;?>&nombre=<?php echo $nombre;?>&APaterno=<?php echo $APaterno;?>&AMaterno=<?php echo $AMaterno;?>">
             ...
             <li class="nav-item">
               ...
               <!--   <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item"  id="nav-eventos">
                      ...
                      <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" id="nav-even-leg-med">
