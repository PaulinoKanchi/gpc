...
<form class="add-new-post" method="post" action="guardado-leg-mat.php?id=<?php echo $id;?>">
...
RAZON SOCIAL: <input size =50 class="mi-selector form-control-lg mb-3" style="margin-left:5px;margin-right:5px" name="proveedor" value="<?php echo $proveedor ;?>" readonly>
 ...
 RFC:<input style="margin-left:10px;margin-right:10px" id="rfc" name="rfc" class="form-control-lg mb-3" type="text" placeholder="RFC" required>
<br>REPRESENTANTE LEGAL:<input size=50 style="margin-left:10px;margin-right:10px" id="replegal" name="replegal" class="form-control-lg mb-3" type="text" placeholder="Representante Legal" required>
...
<tr>
                          <td>  <?php echo "2.Copia simple por ambos lados de la identificación oficial vigente con fotografía. Verificar el nombre, firma autógrafa y fotografía del LICITANTE y/o su Representante Legal. (NO OBLIGATORIO)";?></td>
...
<tr>
                          <td>  <?php echo "3. MANIFIESTO DE NACIONALIDAD Que el LICITANTE y el Representante Legal manifieste su nacionalidad. (PARA NACIONAL ES OBLIGATORIO)";?></td>
...
<tr>
                          <td>  <?php echo "4. Escrito de no encontrarse en los supuestos de los artículos 50 y 60 de la LAASSP. (OBLIGATORIO)"?></td> 
...
<tr>
                          ...
                          <td>  <?php echo "5. Declaración de Integridad. (OBLIGATORIO)"?></td>
...
<tr>
                          <td>  <?php echo "6.Manifestación de estratificación de MIPYME para LICITANTES de nacionalidad mexicana. Que el LICITANTE manifieste cuál es su nivel de estratificación empresarial conforme al Formato L de la presente convocatoria. (NO OBLIGATORIO)"?></td> 
                          <td> <input type="radio" name="cumple6" value="Cumple" onclick="mostrar6(3)" ></td>
                          <td> <input type="radio" name="cumple6" value="No Cumple" onclick="mostrar6(3)" ></td>
...
<tr>
                          ...
                          <td>  <?php echo "7.Escrito de aceptación por el uso de medios electrónicos de comunicación. (OBLIGATORIO)"?></td>
...
<tr>
                          <td>  <?php echo "8. Convenio de Participación Conjunta Que las personas físicas o morales que se agrupen, lo acrediten a través de un acuerdo de voluntades. (OBLIGATORIO SI ES PROPUESTA CONJUNTA)"?></td>
...
<tr>
                          <td>  <?php echo "9. Origen de los Bienes y margen de preferencia Origen de los Bienes y margen de preferencia. (OBLIGATORIO)"?></td>
...
<tr>
                          <td>  <?php echo "10.Escrito en el que el LICITANTE proporcione una dirección de correo electrónico, y en caso contrario, indicar que no cuenta con el mismo. (OBLIGATORIO)"?></td>
