            ...
            <div class="col-lg-9 col-md-12">
              ...
              <div class="card card-small mb-3">
                <div class="card-body">
                  ...
                  <form class="add-new-post" method="post" action="guardado-tec-med-ch.php?id=<?php echo $id; ?>">
...
<?php
                      ...
                      <br>
                      Proveedor: 
                      <select id="provee" class="mi-selector form-control-lg mb-12" name="proveedor" required>
