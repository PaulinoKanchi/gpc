    ...
    <div class="container-fluid">
     ...
     ?>
                ...
                <?php } 
                  ...
                  ?>
                <a href="indexelegal.php?id=<?php echo $id;?>">Regresar</a>
                <?php        }
              ?>  
...
<form class="add-new-post" method="post" action="guardado-leg-mat-ch.php?id=<?php echo $id;?>">

<?php
  include ('mostrar-procesos.php');
          ?>
<select id="proceso2" class="mi-selector form-control-lg mb-3" style="margin-left:5px;margin-right:5px" name="proceso">
<option>Procedimiento</option>
<?php
while ($row = mysqli_fetch_row($mostrar123)) {
?>
...
<?php
  include ('mostrar-proveedores.php');
          ?>
<select class="mi-selector form-control-lg mb-3" style="margin-left:5px;margin-right:5px"name="proveedor">
