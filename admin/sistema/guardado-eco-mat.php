...
$query= "INSERT INTO `material_economica`(`descripcion`,`clave12`,`ospm`,`partida`,`proveedor`,`pais`,
`tecnica_minima`,`tecnica_maxima`,`minofertada`,`maxofertada`,`tecnica1`,`fechacreacion`,`evaluador`,`dictamen`,`comentarios`,`precio`,
`unidad`,`tipo`,`cant`,`causadesechamiento`,`proceso`,`pmr`,`descuento`,`porcentajeabasto`)
VALUES ('$descripcion','$clave12','$osopm','$partida','$proveedor','$pais',
'$cantidadmin','$cantidadmax','$minofertada','$maxofertada','$cumple1', CURRENT_TIMESTAMP,'$evaluador','$dictamen','$comentarios','$precio',
'$unidad','$tipo','$cant','$varc1','$proceso','$precio1','$porcentaje','$porcentajeabasto')";
...
<div>
<div>
<a class="dropdown-item" href="eva-eco-mat-ch.php?id=<?php echo $id;?>"> Nueva evaluación</a>
<!doctype html>
...
<p style="float:left;margin-left:10px"><h3 class="page-title">Material de Curacion</h3></p> 
                    ...
                    <table class="table mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>  <input style="padding:12px;background-color:#dddddd;margin-left:10px;margin-right:0px" name="cantidadmax" id="cantidadmax" class="form-control-lg mb-3"  value="<?php echo $cantidadmax;?>" readonly>
                          <?php echo "Cantidad Min. Solicitada:";?>
                          <input style="padding:12px;background-color:#dddddd;margin-left:10px;margin-right:0px" name="cantidadmin" id="cantidadmin" class="form-control-lg mb-3"  value="<?php echo $cantidadmin;?>" readonly>
                          </tr>
                        ...
                        <tr>
                          <td>  <?php echo "Descuento:";?>
                          <td>  <input style="padding:12px;background-color:#dddddd;margin-left:10px;margin-right:0px" name="maxofertada" id="maxofertada" class="form-control-lg mb-3"  value="<?php echo $porcentaje;?>" readonly>
                          <?php echo "Porcentaje abasto:";?>
                          <input style="padding:12px;background-color:#dddddd;margin-left:10px;margin-right:0px" name="minofertada" id="minofertada" class="form-control-lg mb-3"  value="<?php echo $porcentajeabasto;?>" readonly>
                          </tr>
