...
<!--desde aqui comienza catalogos-->
              <li class="nav-item">
               ...
               <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="eva-tec-mat-ch.php?username=<?php echo $usertra;?>&tipo=<?php echo $tipoo;?>&nombre=<?php echo $nombre;?>&APaterno=<?php echo $APaterno;?>&AMaterno=<?php echo $AMaterno;?>">
