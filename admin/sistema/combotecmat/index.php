		...
		<script language="javascript">
			$(document).ready(function(){
				$("#cbx_estado").change(function () {
					...
					$("#cbx_estado option:selected").each(function () {
						...
						$.post("../sistema/combotecmat/includes/getMunicipio.php", { id_cat_procesos: id_cat_procesos }, function(data){
			...
			$(document).ready(function(){
				$("#cbx_municipio").change(function () {
					...
					$("#cbx_estado option:selected").each(function () {
						id_cat_procesos = $(this).val();
						$.post("../sistema/combotecmat/includes/llenado.php", { id_cat_procesos: id_cat_procesos }, function(data){
							$("#cantidad").html(data);
