          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Material de Curacion</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
                    ...
                    <table class="table mb-0" id="example" class="display" style="width:100%">
                      <thead class="bg-light">
                        ...
                        <th scope="col" class="border-0">ID</th>
                          ...
                          <th scope="col" class="border-0">Caracteristicas</th>
                          <th scope="col" class="border-0">Red Frio</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                             <?php
  include ('mostrar-insumos-material.php');
